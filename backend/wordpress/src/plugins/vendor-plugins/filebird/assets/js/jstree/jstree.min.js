        ...
        keyboard: {
          ...
          left: function (t) {
            if ((t.preventDefault(), this.is_open(t.currentTarget)))
              ...
              i &&
                i.id !== e.jstree.root &&
                this.get_node(i, !0).children(".jstree-anchor").focus();
            }
          },
          up: function (e) {
            e.preventDefault();
      ...
      (e.jstree.core.prototype = {
        ...
        redraw_node: function (t, i, r, s) {
          ...
          if (
            ...
            f[a.parent] &&
            !a.state.hidden &&
            ((l = e.inArray(a.id, f[a.parent].children)), (k = a.id), -1 !== l)
          )
            for (
                  ...
                  o.length &&
                    ...
                    s
                      ...
                      : (this.trigger("before_open", { node: i }),
                        ...
                        o[0].setAttribute("aria-expanded", !0))),
                  (i.state.opened = !0),
                  r && r.call(this, i, !0),
        ...
        check: function (t, i, r, s, a) {
          ...
          return (
            ...
            n && n.functions && (!1 === n.functions[t] || !0 === n.functions[t])
              ...
              : !(
                  !1 === o ||
                  (e.isFunction(o) && !1 === o.call(this, t, i, r, s, a)) ||
                  (o && !1 === o[t])
                ) ||
                ((this._data.core.last_error = {
                  error: "check",
          ...
          if (i.parent === u.id) {
            ...
            for (
              ...
              for (
                p = [],
                  y = 0,
                  k = (x = g._model.data[i.parents[v]].children_d).length;
                y < k;
                y++
              )
      ...
      (e.jstree.plugins.checkbox = function (i, r) {
        (this.bind = function () {
          ...
          (this.get_state = function () {
            ...
            return this.settings.checkbox.tie_selection
              ? e
              : ((e.checkbox = this._data.checkbox.selected.slice()), e);
          }),
            ...
            e(d).on(
              ...
              e.proxy(function (t, i) {
                (this._data.contextmenu.visible = !1),
                  e(i.reference).parent().removeClass("jstree-context");
              }, this)
            );
        }),
            ...
            e(d).one(
              ...
              e.proxy(function (t, i) {
                var r =
                  ...
                  this.get_theme() +
                  "-contextmenu";
                e(i.element).addClass(r), a.parent().addClass("jstree-context");
              }, this)
            ),
            ...
            if (
              ...
              if (T && T._data && T._data.dnd)
                if (
                  ...
                  if (
                    (N = T.settings.dnd.large_drop_target
                      ? e(d.event.target)
                          .closest(".jstree-node")
                          .children(".jstree-anchor")
                    ...
                    e.each(f, function (t, s) {
                      switch (s) {
                        case "b":
                          ...
                          break;
                        case "i":
                          (x = T.settings.dnd.inside_pos),
                            (b = T.get_node(N.parent())),
                            (l = O.left - 2),
                            (h = O.top + _ / 2 + 1),
                            (u = b.id),
                            (g =
                      ...
                      for (p = !0, m = 0, v = d.data.nodes.length; m < v; m++)
                        if (
                          ...
                          "move_node" === j &&
                            ...
                            ((k = T.get_node(u)),
                            y > e.inArray(d.data.nodes[m], k.children) &&
                              (y -= 1)),
                          !(p =
                            p &&
                            ((T &&
              ...
              return e.isFunction(h)
                ? h.call(
                    ...
                    e.proxy(function (t) {
                      t && t.d && (t = t.d),
                        this._load_nodes(
                          e.isArray(t) ? e.vakata.array_unique(t) : [],
                          function () {
        ...
        (this.bind = function () {
          ...
          (this.sort = function (t, i) {
            ...
            if (
              ...
              t.children &&
              t.children.length &&
              (t.children.sort(e.proxy(this.settings.sort, this)), i)
            )
              for (r = 0, s = t.children_d.length; r < s; r++)
